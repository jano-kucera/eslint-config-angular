const pluginAngular = require("@angular-eslint/eslint-plugin");
...
const sortPlugin = require("eslint-plugin-sort");
const sortClassMembers = require("eslint-plugin-sort-class-members");
const unusedImports = require("eslint-plugin-unused-imports");
const globals = require("globals");
const tseslint = require("typescript-eslint");
const tseslintConfigs = require("typescript-eslint").configs;
    ...
    rules: {
      ...
      "no-restricted-imports": [
        ...
        },
        {
          ...
          message:
            "Please import { EventEmitter } from '@angular/core' instead.",
          name: "stream",
        },
        {
          importNames: ["Subject", "Subscription", "Observable"],
          message: "Please import from 'rxjs' instead.",
      ...
      "sort/string-enums": ["warn", { caseSensitive: false, natural: true }],
